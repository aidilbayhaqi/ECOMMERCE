...
const Laptop = () => {
  ...
  const getProducts = async () => {
    ...
    setProducts(
      response.data.filter((product) => product.categories === "LAPTOP")
    );
  };
  ...
  return (
    <div className="relative w-full p-10 mt-5 items-center justify-center text-center gap-5 ">
      <div className="justify-between px-5 mb-5 flex flex-col md:flex-row">
        <h1 className="font-bold text-4xl">LAPTOP</h1>
        <Link href={`/categories/laptop`}>See All</Link>
      </div>
